clear
echo ""
echo "Installing Dirty Unicorns Nougat 7.0"
echo ""
sleep 1
...
then
  ...
  echo ""
  echo "Downloading Banks Gapps.."
  echo ""
  sleep 1
  wget -c --quiet --show-progress --tries=10 https://download.dirtyunicorns.com/gapps/Banks/banks_dynamic_gapps-7.x.x-20160921.zip
  echo ""
  sleep 2
  clear
  echo ""
  ...
  echo ""
  echo "  → GApps zip"
  adb push -p banks_dynamic_gapps-7.x.x-20160921.zip /sdcard/
  echo ""
  echo "========================================="
  sleep 1
  echo ""
  ...
  echo ""
  sleep 3
  adb shell twrp install /sdcard/banks_dynamic_gapps-7.x.x-20160921.zip
  echo ""
  echo "Wipe cache.."
  echo ""
